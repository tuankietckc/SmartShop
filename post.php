	...
	<div class="container">
		<div class="col-md-6 single-right-left animated wow slideInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInUp;">
			<div class="grid images_3_of_2">
				...
				<div class="flex-viewport" style="overflow: hidden; position: relative;"><ul class="slides" style="width: 1200%; transition-duration: 0.6s; transform: translate3d(-806px, 0px, 0px);"><li data-thumb="images/d4.jpg" class="clone" aria-hidden="true" style="width: 403px; float: left; display: block;">
							<div class="thumb-image"> <img src="images/d4.jpg" data-imagezoom="true" class="img-responsive" draggable="false"> </div>
						</li>
						<li data-thumb="images/d2.jpg" style="width: 403px; float: left; display: block;" class="">
							<div class="thumb-image"> <img src="images/d2.jpg" data-imagezoom="true" class="img-responsive" draggable="false"> </div>
						</li>
						<li data-thumb="images/d1.jpg" style="width: 403px; float: left; display: block;" class="flex-active-slide">
							<div class="thumb-image"> <img src="images/d1.jpg" data-imagezoom="true" class="img-responsive" draggable="false"> </div>
						</li>	
						<li data-thumb="images/d3.jpg" style="width: 403px; float: left; display: block;">
		...
		<div class="col-md-6 single-right-left simpleCart_shelfItem animated wow slideInRight animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInRight;">
					...
					<div class="description">
						<h5>Viết mô tả vắn tắt ở đây</h5>
					</div>
					...
					<div class="occasional">
						<h5>Kích thước hoặc màu sắc của quần áo nằm ở đây :</h5>
						<div class="colr ert">
